      ...
      <div className="container contact__container">
        <div className="contact__options">
            ...
            <article className="contact__option">
              ...
              <a href="mailto:pablo.javier.torres.martinez@gamil.com">Send a message</a>
            </article>
            ...
            <article className="contact__option">
              ...
              <a href="http://m.me/pablo.martinez.96995">Send a message</a>
            </article>
            ...
            <article className="contact__option">
              ...
              <h4>WhatsApp</h4>
              <h5>5560075650</h5>
              <a href="https://api.whatsapp.com/send?phone=525560075650">Send a message</a>
            </article>
